...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()  # store_true 是指带触发action时为真，不触发则为假
    parser.add_argument('--weights', type=str, default='./weights/yolov5s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='./models/yolov5s.yaml', help='model.yaml path')  # 网络配置
    parser.add_argument('--data', type=str, default='../NEU-DET/data.yaml', help='data.yaml path')  # 数据

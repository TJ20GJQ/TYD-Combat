...
# --weights ./runs/exp6/weights/best.pt --source ../NEU-DET/valid/images --output ../NEU-DET/output
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/exp6/weights/best.pt', help='model.pt path(s)')

...
def cal_rpn(imgsize, featuresize, scale, gtboxes):
    ...
    # gen base anchor
    base_anchor = gen_anchor(featuresize, scale)  # 生成候选框900*1600->56*100个特征点
    ...
    anchor_max_overlaps = overlaps[range(overlaps.shape[0]), anchor_argmax_overlaps]  # 计算重合度，取重合大的候选框
